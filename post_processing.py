...
class configuration():
    ...
    def make_conf_file(self, svm_performance_report):
        ...
        outputArray.append("Number of vectors from each source=%s\n"%self.number_of_vectors_from_each_source)
        ...
        outputArray.append(svm_performance_report)
        outputArray.append("Total number of words/freq in dataset: %s\n" % self.max_words)
        outputArray.append("Total number of tri-grams/freq in dataset: %s\n" % self.max_trigrams)
        outputArray.append("Max edit distance: %s\n" % self.max_edit_distance)
        outputArray.append("Min edit distance: %s\n" % self.min_edit_distance)
        outputArray.append("Number of pages from each source processed (0 means all pages): %s" %self.sample_size)
